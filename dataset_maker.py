...
# Funzione per ottenere la categoria generica, None se non è presente
...
def filter_and_prepare_csv(input_csv_path, output_csv_path, min_instances=5000):
    ...
    # Lista dei valori da rimuovere - alimenti o categorie inadatti
    ...
    # Colonna delle categorie generiche, fondamentale per la scelta nella UI
...
output_csv_path = '/Users/lucavisconti/Documents/FoodAI/csv/prepared_food_data.csv'
