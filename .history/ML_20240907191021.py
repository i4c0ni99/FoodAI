...
output_file_path = '/Users/i4c0ni99/UNIVAQ/develop/FoodAI/csv/trained-data.csv'
df_output.to_csv(output_file_path, index=False)

print(f"File di output salvato come {output_file_path}")

# Statistiche addestramento
stats_file_path = '/Users/i4c0ni99/UNIVAQ/develop/FoodAI/csv/ML_results.json'
...
# Ottieni i feedback e aggiorna i dati
