...
output_json_path = '/Users/lucavisconti/Documents/FoodAI/json/output.json'
...
def save_feedback_to_json(feedback_data, file_path):
    with open(file_path, 'w') as file:
        json.dump(feedback_data, file, indent=4)


def get_feedback_and_update(df_trained, df_linear, approved_categories_file, stats_file_path, output_json_path):
    ...
    # Lista per memorizzare i feedback
    feedback_data = []
    ...
    for category in categories:
        ...
        if feedback == 'stop':
            ...
            save_feedback_to_json(feedback_data, output_json_path)
...
df_updated = get_feedback_and_update(df_trained, df_linear, approved_categories_file, stats_file_path, output_json_path)
