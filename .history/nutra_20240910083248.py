...
# Dizionario di mapping delle categorie duplicate (come da codice precedente)
# ... (mantieni il codice del mapping qui)

# Funzione per sostituire le categorie
# ... (mantieni il codice per replace_category e update_categories_in_csv)
...
y = (y - y.min()) / (y.max() - y.min()) * 100  # Normalizzazione
