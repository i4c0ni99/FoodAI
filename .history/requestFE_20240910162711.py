...
async def get_form(request: Request):
    c.execute('SELECT * FROM carbohydrate ORDER BY kilocalories DESC')
    return templates.TemplateResponse("calculateMacro.html", {"request": request})
...
@app.post("/crono_day", response_class=HTMLResponse)
async def post_crono(request: Request):
